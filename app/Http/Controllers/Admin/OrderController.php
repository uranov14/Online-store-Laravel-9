...
class OrderController extends Controller
{
    ...
    public function updateOrderItemStatus(Request $request) {
        if ($request->isMethod('post')) {
            $data = $request->all();
            //echo "<pre>"; print_r($data); die;
            //Update Order Item Status table
            ...
            if (!empty($data['item_courier_name']) && !empty($data['item_tracking_number'])) {
                Order::where('id', $getOrderId['order_id'])->update(['courier_name'=>$data['item_courier_name'], 'tracking_number'=>$data['item_tracking_number']]);
                OrderProduct::where('id', $data['order_item_id'])->update(['courier_name'=>$data['item_courier_name'], 'tracking_number'=>$data['item_tracking_number']]);
            }
            ...
            <header class="clearfix">
                <div class="container">
                    <div class="company-address">
                        <h2 class="title">Ukrainian Sector</h2>
                        <p>
                            Your any address,<br>
                            Kyiv, Ukrain
                        </p>
                ...
                <div class="container">
                    <div class="details clearfix">
                        <div class="client left">
                            ...
                            <p>'.$orderDetails['address'].', '.$orderDetails['city'].', '.$orderDetails['state'].', '.$orderDetails['country'].', Pincode: '.$orderDetails['pincode'].'</p>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        foreach ($orderDetails['orders_products'] as $product) {
                            $invoiceHTML .= '<tr>
                                ...
                                <td class="qty">'.$product['product_price'] * $product['product_qty'].' $</td>
                            </tr>';
                        ...
                        <table class="grand-total">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="qty"></td>
                                    <td class="qty"></td>
                                    <td class="total">SHIPPING CHARGES:</td>
                                    <td class="total">0 $</td>
                                </tr>
                                <tr>
                                    <td class="qty"></td>
                                    ...
                                    <td class="qty"></td>
                                    <td class="qty"></td>
                                    <td class="total">COUPON DISCOUNT:</td>';
