      ...
      <div class="row">
          ...
          <div class="login-wrapper">
            ...
            <form action="{{ url('admin/login') }}" method="POST">
              ...
              <div class="u-s-m-b-30">
                ...
                <input type="email" name="email" id="vendor-email" class="text-field" placeholder="Enter Email">
              </div>
              <div class="u-s-m-b-30">
        ...
        <div class="col-lg-6">
          <div class="reg-wrapper">
            ...
            <form 
              id="vendorForm" 
              action="{{ url('vendor/register') }}"
              method="post"
            >@csrf
              <div class="u-s-m-b-30">
                <label for="vendor-name">Name
                  <span class="astk">*</span>
                </label>
                <input type="text" 
                  id="vendor-name" 
              ...
              <div class="u-s-m-b-30">
                <label for="vendor-mobile">Mobile
                  <span class="astk">*</span>
                </label>
                <input type="text" 
                  id="vendor-mobile" 
